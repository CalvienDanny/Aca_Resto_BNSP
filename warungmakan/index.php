        ...
        <div class="container">
            <div class="row py-5 mt-4 align-items-center">
                ...
                <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
                    <img src="https://img.freepik.com/premium-vector/healthy-eating-woman-cooking-nutritious-meal-with-fresh-vegetables-wellequipped-kitchen_759447-641.jpg?w=1060" alt="" class="img-fluid mb-3 d-none d-md-block">
                    <h1>Selamat Datang di Warung Makan Aca</h1>
                    <p class="font-italic text-muted mb-0">Silahkan Login atau Register akun anda untuk menikmati fitur kami lebih lanjut</p>
                    <p class="font-italic text-muted">Info Lebih lanjut bisa hubungi<a href="https://wa.me/+6285856036828" class="text-muted">
                            <u>Admin Kami (Aca)</u></a>
                    </p>
                </div>
                ...
                <div class="col-md-7 col-lg-6 ml-auto">
                    ...
                    <form id="register-form" method="Post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <div class="text-left w-100 mb-4 ml-3">
                            <p class="text-green h3 font-weight-bold text-uppercase">Register Form</p>
                            <?php
                            if (isset($error)) {
                                foreach ($error as $e) { ?>
                        ...
                        <div class="container">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" name="name" class="form-control" placeholder="Huruf Awal">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="lname" class="form-control" placeholder="Huruf Akhir">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12 mx-auto mb-0">
                            <input type="submit" name="register" class="btn btn-primary btn-block py-2 font-weight-bold" value="Buat Akun">
                        </div>
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Sudah Terdaftar? <a href="#" id="login" class="text-primary ml-2">Login</a></p>
                        </div>
                    </form>
                    ...
                    <form id="login-form" method="Post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="form-check col-lg-12 mb-3 ml-3">
                            ...
                            <label class="form-check-label text-muted font-weight-bold" for="exampleCheck1">Ingat Akun Saya</label>
                        </div>
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold"><a href="forgotPassword.php" class="text-primary ml-2">Lupa Password?</a></p>
                        </div>
                        <div class="form-group col-lg-12 mx-auto d-flex align-items-center my-4">
                            <div class="border-bottom w-100 ml-5"></div>
                            <span class="px-2 small text-muted font-weight-bold text-muted">Atau</span>
                        ...
                        <!-- Already Registered -->
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Belum Punya Akun? <a href="#" id="register" class="text-primary ml-2">Register</a></p>
                        </div>
                    </form>
                </div>
            </div>
