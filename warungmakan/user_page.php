...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        // Check if the cookie 'shopping_cart' exists
            ...
            if (is_array($cart_data)) {
                foreach ($cart_data as $keys => $values) {
                    if ($cart_data[$keys]['item_id'] == $_GET["id"] && $cart_data[$keys]['session_id'] == $session_id) {
                        ...
                        $item_data = json_encode(array_values($cart_data)); // Use array_values to re-index the array
                        setcookie("shopping_cart", $item_data, time() + 600);
                        header("location:user_page.php?remove=1");
                        exit(); // Ensure the script stops executing after the redirect
                    }
                }
            } else {
                // Handle the case where the cookie data is not valid JSON or empty
                // For example, you could set an empty array
                $cart_data = [];
            }
        } else {
            // Handle the case where the shopping_cart cookie does not exist
            $cart_data = []; // Initialize as empty array if cookie doesn't exist
        }
    }
}
    ...
    if ($_GET["action"] == "clear") {
        ...
        if (isset($_COOKIE['shopping_cart'])) {
            ...
            if (is_array($cart_data)) {
                ...
                // Re-index the array and save it back to the cookie
                $item_data = json_encode(array_values($cart_data));
                setcookie("shopping_cart", $item_data, time() + 600);
                header("location:user_page.php?clearall=1");
                exit(); // Ensure the script stops executing after the redirect
            } else {
                // Handle the case where the cookie data is not valid JSON
                $cart_data = [];
            }
        }
    }
...
<body>
        ...
        <section class="header-main border-bottom py-2">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-2 col-4" style = "margin-bottom: 0;">
                        <a href="user_page.php" class="brand-wrap">
                            <img class="logo" src="image/logo-01.png" width=200>
                        </a> <!-- brand-wrap.// -->
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <form action="#" class="search  ms-5">
                            <div class="input-group w-100">
                                <input type="text" class="form-control" id="search_button" placeholder="Cari Disini">
                                ...
                                <li class="nav-item me-2">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="changePassword.php">Ganti Password</a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item" href="logoutadmin.php">Keluar</a></li>
                                        </ul>
                                    </div>
                                </li>
                            ...
                            <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="form-check">
                                        <input class="form-check-input radio" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="Old Product">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Paket Terlaris
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input radio" type="radio" name="flexRadioDefault" id="flexRadioDefault2" value="New Product">
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            Paket Terbaru
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input radio" type="radio" name="flexRadioDefault" id="flexRadioDefault2" value="Hight Price">
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            Harga Teratas
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input radio" type="radio" name="flexRadioDefault" id="flexRadioDefault2" value="Low Price">
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            Harga Terbawah
                                        </label>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-7 offset-md-3">
                                <div class="d-flex">
                                    ...
                                    <div class="px-3 text-uppercase fs-2">Paket Kami</div>
                                    <hr class="my-auto flex-grow-1">
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="table-responsive">
                                        <?php echo $message; ?>
                                        <div align="right">
                                            <a href="user_page.php?action=clear" class="btn btn-danger btn-sm mb-1"><b>Hapus Item <i class="fa fa-trash-alt"></i></b></a>
                                        </div>
                                        <table class="table table-bordered">
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>Rupiah <?php echo $values["item_price"]; ?></td>
                                                            <td>Rupiah <?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">Rupiah <?php echo number_format($total, 2); ?></td>
                                                    <td></td>
                                                </tr>
                                            <?php
                                            } else {
    ...
    ';
                                        ...
                                        <div class="float-end">
    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#confirmationModal">Proses Checkout</button>
</div>

<!-- Spacer to create space between button and modal -->
<div class="mb-5"></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="checkout.php" class="btn btn-primary">Ya, Lanjutkan</a>
            </div>
        </div>
    </div>
</div>
