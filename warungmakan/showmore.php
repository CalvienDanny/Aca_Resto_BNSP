    ...
    <main class="mt-5">
        <div class="container">
            ...
            if ($total_row > 0) {
                foreach ($res as $row) {
            ?>
                    <div class="card mb-3 mx-auto" style="max-width: 2000px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="image/<?php echo $row['images'] ?> " alt="..." class="mt-2" style="width: 350px;" height=290px>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title"> <?php echo $row['title'] ?></h5>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item text-uppercase"><i class="fas fa-user-alt fa-lg"></i> Jumlah Orang: <span class="fw-bolder ps-2"><?php echo $row['display'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas fa-clock fa-lg"></i> Waktu: <span class="fw-bolder ps-2"><?php echo $row['battery'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas  fa-utensils fa-lg"></i> Makanan: <span class="fw-bolder ps-2"><?php echo $row['hardware'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas fa-coffee fa-lg"></i> Minuman: <span class="fw-bolder ps-2"><?php echo $row['camera'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas fa-money-check-alt fa-lg"></i> Harga: <span class="fw-bolder ps-2"><?php echo $row['price'] ?> Rupiah</span></li>
                                    </ul>
                                    <div class="container">
                                            ...
                                            <div class="col-md-auto">
                                                <form method="POST" action="add_to_card.php">
                                                    <div class="input-group mt-3">
                                                        ...
                                                        <button class="btn btn-sm btn-primary px-5 me-5 me-5" name="add_to_cart" type="submit" id="button-addon2"><i class="fas fa-cart-plus"></i> Buat Pesanan</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
