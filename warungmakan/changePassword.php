                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="mb-3">
                                <label for="formGroupExampleInput" class="form-label">Password Sebelumnya</label>
                            ...
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Konfirmasi Password Baru</label>
                                <input type="password" class="form-control" id="formGroupExampleInput2" name="CNewpassword">
                            </div>
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <button class="btn btn-outline-primary" type="submit" name="submit">Selesai</button>
                            </div>
                        </form>
                    </div>
                </div>
