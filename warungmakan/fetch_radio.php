...
$display = new Products();
  ...
  foreach($res as $row)
  {
   ...
   <div class="card h-100 my-2">
       ...
       <div class="card-body">
           ...
           <h6 class="card-subtitle mb-2 text-muted">'. $row['price'] .' Rupiah</h6>
 ...
 echo $output;
     ...
     }else if($_POST["radio"] == "New Product"){
        $query = "
        SELECT * FROM products 
        ORDER BY id DESC;
       ";
 ...
 echo $output;
     }else if($_POST["radio"] == "Hight Price"){
        $query = "
        SELECT * FROM products 
        ORDER BY price DESC;
       ";
